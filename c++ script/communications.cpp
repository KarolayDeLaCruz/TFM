...
//Entradas: vector de char sendVector
//Salidas: ninguna
void sendMessageRL(vector <unsigned char> sendVector, int client_number)
{
...
void closeSocket()
{
	...
	/*int iResult2 = shutdown(ClientSocket, SD_SEND);
